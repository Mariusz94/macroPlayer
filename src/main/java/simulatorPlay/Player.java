...
public class Player {
    ...
    private static Point leftUpperCorner = new Point(1555, 807);
    private static Point rightUpperCorner = new Point(1725, 807);
    private static Point leftBottomCorner = new Point(1555, 900);
    private static Point rightBottomCorner = new Point(1725, 900);

    private static Point auto = new Point(1899, 68);
    private static Color autoColor = new Color(199, 180, 65);
    private static Point auto2 = new Point(1843, 65);
    private static Color autoColor2 = new Color(190, 180, 54);

    private static Point sync = new Point(1641, 827);
    private static Color syncColor = new Color(255, 192, 137);

    private static Color colorGame = new Color(130, 121, 124);

    private static Point cordsToCheck = new Point(1647, 774);
